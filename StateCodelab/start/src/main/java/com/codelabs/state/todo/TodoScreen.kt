...
fun TodoRow(
    ...
    Row(
        ...
        Text(todo.task)
        /*
        // 1. Adding random to a composable
        val iconAlpha = randomTint()
        */

        /*// 2. Introducing memory to composable functions
...
fun TodoItemInput(onItemComplete: (TodoItem) -> Unit) {
    ...
    // This pattern of passing a lambda is the main way that you define custom events in compose.
